...
public class Enemy4 : MonoBehaviour
{
    ...
    public GameObject exBallPrefab; // Assign ExBall50 prefab in inspector
    ...
    private void DropItem()
    {
        ...
        if (randomValue <= exBallDropChance)
        {
            ...
            if (exBallPrefab != null)
            {
                ...
                Debug.Log("Enemy4 dropped ExBall");
            }
        }
        else
        {
    ...
    private void DropRandomPowerup()
    {
        ...
        if (powerups.Count > 0)
        {
            ...
            Debug.Log($"Enemy4 dropped powerup: {selectedPowerup.name}");
        }
        else
        {
            ...
            {
                Instantiate(exBallPrefab, transform.position, Quaternion.identity);
                Debug.Log("Enemy4 dropped ExBall (fallback)");
            }
        }
    }
}
