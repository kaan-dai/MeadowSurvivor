...
public class Enemy1 : MonoBehaviour
{
    ...
    public GameObject exBallPrefab; // Assign ExBall10 prefab in inspector
    ...
    private void DropItem()
    {
        ...
        if (randomValue <= exBallDropChance)
        {
            ...
            if (exBallPrefab != null)
            {
                ...
                Debug.Log("Enemy1 dropped ExBall");
            }
        }
        else
        {
    ...
    private void DropRandomPowerup()
    {
        ...
        if (powerups.Count > 0)
        {
            ...
            Debug.Log($"Enemy1 dropped powerup: {selectedPowerup.name}");
        }
        else
        {
            ...
            {
                Instantiate(exBallPrefab, transform.position, Quaternion.identity);
                Debug.Log("Enemy1 dropped ExBall (fallback)");
            }
        }
    }
}